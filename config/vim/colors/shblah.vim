...
highlight Identifier   term=NONE cterm=bold ctermfg=2    ctermbg=NONE
highlight IncSearch    term=NONE cterm=bold ctermfg=15    ctermbg=5
...
highlight StatusLine   term=NONE cterm=bold ctermfg=15    ctermbg=NONE
